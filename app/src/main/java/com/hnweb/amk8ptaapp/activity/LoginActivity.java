...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_createaccount = (TextView) findViewById(R.id.tv_register);
                                ...
                                builder.setMessage(message)
                                        ...
                                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog, int id) {
                                                ...
                                                try {
                                                    JSONObject jsonObject = j.getJSONObject("login_details");

                                                    String user_id = jsonObject.getString(AppConstant.KEY_ID);
                                                    String user_fname = jsonObject.getString(AppConstant.KEY_FIRSTNAME);
                                                    String user_lname = jsonObject.getString(AppConstant.KEY_LASTNAME);
                                                    String user_email = jsonObject.getString(AppConstant.KEY_EMAIL);
                                                    String user_phone = jsonObject.getString(AppConstant.KEY_MOBILENO);

                                                    editorUser.putString(AppConstant.KEY_ID, user_id);
                                                    editorUser.putString(AppConstant.KEY_FIRSTNAME, user_fname);
                                                    editorUser.putString(AppConstant.KEY_LASTNAME, user_lname);
                                                    editorUser.putString(AppConstant.KEY_EMAIL, user_email);
                                                    editorUser.putString(AppConstant.KEY_MOBILENO, user_phone);
                                                    editorUser.commit();
